...
function AccordionTrigger({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Header$1, { className: "flex", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Trigger2,
    {
...
const WORKSHOPS = [
  {
    ...
    description: "Master the principles of soil health, cover cropping, and no-till practices that build long-term farm productivity.",
    icon: "🌱"
  },
  {
    id: 2,
    title: "Composting Masterclass",
    description: "From kitchen scraps to black gold — learn hot composting, vermicomposting, and bokashi fermentation techniques.",
    icon: "♻️"
  },
  {
    id: 3,
    title: "Seasonal Planting Guide",
    description: "Understand crop rotation, companion planting, and succession sowing to maximize your harvest year-round.",
    icon: "📅"
  },
  {
    id: 4,
    title: "Natural Pest Management",
    description: "Deploy beneficial insects, companion plants, and organic sprays to protect crops without chemicals.",
    icon: "🐛"
  },
  {
    id: 5,
    title: "Water Conservation",
    description: "Drip irrigation, rainwater harvesting, and swale design to grow more with less water.",
    icon: "💧"
  },
  {
    id: 6,
    title: "Farm-to-Table Processing",
    description: "Preservation, fermentation, and value-added product creation to maximize your harvest yields.",
    icon: "🫙"
  }
];
const PROGRAMS = [
...
const BYPRODUCTS = [
  {
    ...
    description: "Rich in NPK and beneficial microbes, our compost-based fertilizer transforms depleted soil into thriving growing ground.",
    benefits: [
  ...
  },
  {
    ...
    category: "Soil Amendment",
    description: "Fully matured compost from our livestock and crop residues — the foundation of healthy, productive soil.",
    benefits: [
  ...
  },
  {
    ...
    description: "Pasture-raised hens produce eggs with deep golden yolks, rich in omega-3 and vitamins from natural foraging.",
    benefits: [
  ...
  },
  {
    ...
    category: "Animal Products",
    description: "Cold-pressed milk from our grass-fed dairy herd, packed with natural enzymes and beneficial probiotics.",
    benefits: [
      "Grass-fed herd",
      "Natural probiotics",
      "Rich in CLA",
  ...
  },
  {
    ...
    name: "Biochar Blend",
    category: "Soil Amendment",
    description: "Our proprietary biochar activates soil biology, locks in carbon, and improves moisture retention for decades.",
    benefits: [
  ...
  },
  {
    ...
    description: "Open-pollinated, non-GMO seeds curated from 20+ generations of careful selection for flavor and resilience.",
    benefits: [
      "Seed saving allowed",
      "Disease resistance",
      "Flavor-optimized",
...
const USE_CASES = [
  {
    ...
    description: "Our organic fertilizers and biochar blends are trusted by commercial farmers to restore depleted soils and boost crop yields sustainably.",
    icon: "🌾",
    examples: [
  ...
  },
  {
    ...
    description: "From raised beds to window boxes, our compost and seed collections help home gardeners grow nutritious food in any space.",
    icon: "🏡",
    examples: [
  ...
  },
  {
    ...
    description: "Professional landscapers rely on our soil amendments for lush, chemical-free lawns, native plantings, and ornamental gardens.",
    icon: "🌺",
    examples: [
  ...
  },
  {
    ...
    description: "Educational gardens thrive with our beginner-friendly product line, complete with guidance and seed-to-harvest curriculum.",
    icon: "🏫",
    examples: [
  ...
  },
  {
    ...
    description: "Our specialized compost teas and biochar additives enhance water quality and plant nutrition in closed-loop growing systems.",
    icon: "💧",
    examples: [
  ...
  },
  {
    ...
    description: "Partnering with conservancies and land trusts, we supply living soil biology to bring degraded ecosystems back to life.",
    icon: "🌍",
    examples: [
...
const ACHIEVEMENTS = [
  {
    ...
    year: "2024",
    description: "Awarded by the National Organic Farmers Association for outstanding sustainable practices and community impact.",
    icon: "🏆",
    type: "award"
  },
  {
    ...
    year: "2012",
    description: "Continuously certified USDA Organic for 12+ years — zero pesticides, synthetic fertilizers, or GMO inputs.",
    icon: "🌿",
    type: "cert"
  },
  {
    ...
    year: "2023",
    description: "Recognized by GreenFuture Coalition for our carbon-negative operations and regenerative land practices.",
    icon: "♻️",
    type: "award"
  },
  {
    ...
    year: "2021",
    description: "Certified by B Lab for meeting the highest verified standards of social and environmental performance.",
    icon: "⭐",
    type: "cert"
  },
  {
    ...
    year: "2023",
    description: "Over 10,000 students from 50+ schools have participated in our farm education and food literacy programs.",
    icon: "📚",
    type: "milestone"
  },
  {
    ...
    year: "2022",
    description: "Achieved zero-waste certification — 100% of farm byproducts are composted, upcycled, or converted to energy.",
    icon: "🌱",
    type: "milestone"
  }
];
...
const TESTIMONIALS = [
  {
    ...
    quote: "Nettes Garden has transformed my kitchen. The freshness and flavor of their produce is unmatched — my customers notice it every single meal. I wouldn't source from anywhere else.",
    avatar: "SC"
  },
  {
    id: 2,
    ...
    quote: "The school farm tour program changed how my students understand food. They came back with a new respect for nature and a genuine curiosity about sustainability. Truly impactful.",
    avatar: "MT"
  },
  {
    id: 3,
    name: "Linda Okafor",
    role: "Home Gardener",
    quote: "I attended the composting masterclass and it revolutionized my garden. My soil went from hard clay to rich, living earth in one season. The team is incredibly knowledgeable and approachable.",
    avatar: "LO"
  },
  {
    id: 4,
    ...
    quote: "After transitioning to Nettes Garden's organic fertilizer blend, my yields actually improved while my input costs dropped. The soil health improvement has been remarkable and measurable.",
    avatar: "DR"
  },
  {
    id: 5,
    ...
    quote: "I recommend Nettes Garden eggs and dairy to all my clients. The nutritional density is noticeably higher — you can taste the difference that genuine pasture-raising makes.",
    avatar: "EB"
  },
  {
    id: 6,
    ...
    quote: "Their heirloom seed collection has brought biodiversity back to our community plots. Three seasons in and we have varieties that grandparents remember but had never seen again.",
    avatar: "JW"
  }
];
const AVATAR_COLORS = [
...
const FAQS = [
  {
    ...
    answer: "Yes. Nettes Garden has been USDA Organic Certified since 2012. All produce, dairy, eggs, and soil products are grown or raised without synthetic pesticides, herbicides, GMO inputs, or artificial fertilizers. Our certification is audited annually by a third-party certifier."
  },
  {
    id: 2,
    question: "Can I visit the farm?",
    answer: "Absolutely! We welcome farm visitors, especially for our scheduled school tours, monthly open days, and seasonal harvest events. Contact us to book a group tour or check our calendar for upcoming open farm days. Private visits can also be arranged for researchers, educators, and media."
  },
  {
    id: 3,
    question: "How can I register for a workshop or training program?",
    answer: "Use the contact form on our website or email us directly at programs@nettesgarden.com. Workshops run monthly and fill quickly, so we recommend booking at least 2-3 weeks in advance. Student groups and non-profits receive discounted pricing."
  },
  {
    id: 4,
    question: "Do you ship your soil products and seeds nationwide?",
    answer: "Yes, we ship compost, organic fertilizer, biochar blends, and our heirloom seed collections across the continental US. Orders over $75 qualify for free standard shipping. We use eco-friendly packaging and consolidate shipments to minimize our carbon footprint."
  },
  {
    id: 5,
    question: "How does your compost differ from store-bought products?",
    answer: "Commercial compost is often made from a single material type (wood chips, yard waste) and may not be fully matured. Our farm compost is a diverse blend of livestock manure, crop residues, food scraps, and biochar — fully thermophilic-composted for 90+ days, teeming with beneficial microorganisms and far richer in organic matter."
  },
  {
    id: 6,
    question: "Do you offer CSA (Community Supported Agriculture) memberships?",
    answer: "Yes! Our seasonal CSA runs spring through fall. Members receive weekly boxes of freshly harvested vegetables, eggs, and seasonal extras. We offer half-share and full-share options, with pickup at the farm or 12 community drop points across the county."
  },
  {
    id: 7,
    question: "What is your return or satisfaction policy?",
    answer: "We stand behind every product we sell. If you are unsatisfied with a purchase for any reason, contact us within 14 days and we will offer a replacement, store credit, or full refund. For perishable items, please report issues within 48 hours of delivery with a photo."
  }
];
const INITIAL_FORM = {
  name: "",
...
function Header() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "header",
    {
      className: `fixed top-0 left-0 right-0 z-50 transition-smooth ${isScrolled ? "bg-card/95 backdrop-blur-sm border-b border-border shadow-subtle" : "bg-card/80 backdrop-blur-sm"}`,
      "data-ocid": "header",
            ...
            "button",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-tight", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block font-display font-semibold text-foreground text-base tracking-tight", children: "Nettes Garden" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-[10px] font-body font-medium text-muted-foreground uppercase tracking-widest -mt-0.5", children: "Farm" })
                ] })
              ]
            }
          ),
              ...
              children: NAV_LINKS.map((link) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    className: `relative px-3 py-2 text-sm font-medium rounded-md transition-smooth ${isActive ? "text-primary" : "text-foreground/70 hover:text-foreground hover:bg-muted/60"}`,
                    "data-ocid": `header.nav_${sectionId}`,
                    children: [
                      link.label,
                      isActive && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute bottom-0 left-1/2 -translate-x-1/2 w-4 h-0.5 rounded-full bg-primary" })
                    ]
                  },
                  link.href
                );
...
function Footer() {
  ...
  const handleNewsletterSubmit = (e) => {
    e.preventDefault();
    if (!email) return;
    ue.success("Subscribed! Welcome to the Nettes Garden community.");
    setEmail("");
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card border-t border-border", "data-ocid": "footer", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 py-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-full bg-primary flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Leaf,
            {
              className: "w-4.5 h-4.5 text-primary-foreground",
              strokeWidth: 2.5
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-tight", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block font-display font-semibold text-foreground text-base", children: "Nettes Garden" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-[10px] font-body uppercase tracking-widest text-muted-foreground", children: "Farm" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed mb-5", children: "Growing fresh, sustainable, and smart produce since 2008. Rooted in community, driven by nature." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2.5", children: QUICK_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            onClick: () => handleNavClick(link.href),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-semibold text-foreground mb-4", children: "Contact" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground", children: "123 Green Valley Road, Harvest County, CA 94102" })
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                ...
                className: "text-sm text-muted-foreground hover:text-primary transition-smooth",
                children: "hello@nettesgarden.com"
              }
            )
          ] })
        ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-semibold text-foreground mb-2", children: "Stay Updated" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-4", children: "Get seasonal tips, harvest news, and workshop announcements." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "form",
          {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border py-5 flex flex-col sm:flex-row items-center justify-between gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
        "© ",
        year,
        " Nettes Garden. All rights reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
...
function Layout({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 pt-16 lg:pt-20", children }),
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              backgroundImage: "url('/assets/generated/hero-farm.dim_1600x900.jpg')"
            }
          }
        ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 container mx-auto px-4 lg:px-8 py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref, className: "max-w-2xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: `mb-6 ${isVisible ? "fade-in" : "opacity-0-initial"}`,
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: "bg-accent/20 text-accent-foreground border border-accent/40 backdrop-blur-sm px-4 py-1.5 text-sm font-medium animate-float", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Leaf, { className: "w-3.5 h-3.5 mr-1.5" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "h1",
            {
              className: `font-display font-bold text-5xl sm:text-6xl lg:text-7xl leading-tight text-primary-foreground mb-6 text-balance ${isVisible ? "slide-up animate-delayed-1" : "opacity-0-initial"}`,
              children: [
                "Growing Fresh, ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent", children: "Sustainable," }),
                " and Smart"
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              className: `text-base sm:text-lg text-primary-foreground/85 leading-relaxed mb-8 max-w-xl ${isVisible ? "slide-up animate-delayed-2" : "opacity-0-initial"}`,
              children: "At Nettes Garden, we combine generations of farming wisdom with modern sustainable practices to bring nature's finest to your table — and your community."
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: `flex flex-wrap gap-3 mb-12 ${isVisible ? "slide-up animate-delayed-3" : "opacity-0-initial"}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Button,
                  {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: `flex flex-wrap gap-8 ${isVisible ? "fade-in animate-delayed-4" : "opacity-0-initial"}`,
              children: [
                { value: "15+", label: "Years of Farming" },
                { value: "500+", label: "Acres Cultivated" },
                { value: "2000+", label: "Happy Families" }
              ].map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-primary-foreground", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-3xl text-accent", children: stat.value }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-primary-foreground/70 mt-0.5", children: stat.label })
              ] }, stat.label))
            }
          )
        ] }) }),
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: "bg-primary/10 text-primary border-primary/20 mb-4 px-4 py-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "w-3.5 h-3.5 mr-1.5" }),
                "Education & Learning"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-4xl lg:text-5xl text-foreground mb-4 text-balance", children: [
                "Learn to Farm ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Sustainably" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed", children: "We believe knowledge is the most powerful seed. Our education programs equip farmers, students, and communities with practical, science-backed skills for a greener future." })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-12 items-center mb-20", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-3xl text-foreground", children: "Farming Guides & Tutorials" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed", children: "From beginner plots to commercial operations, our step-by-step guides cover every aspect of sustainable agriculture. Learn at your own pace with expert-curated content." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-4", children: PROGRAMS.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    className: `flex items-start gap-3 ${cardsVisible ? `slide-up animate-delayed-${i + 2}` : "opacity-0-initial"}`,
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-lg bg-primary/10 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(p.icon, { className: "w-4.5 h-4.5 text-primary" }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium text-sm text-foreground", children: p.title }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground mt-0.5 leading-relaxed", children: p.desc })
                      ] })
                    ]
                  },
                  p.title
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Button,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Tractor, { className: "w-4 h-4 mr-2" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-6", children: WORKSHOPS.map((workshop, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Card,
          {
            className: `border-border shadow-card hover-lift cursor-default bg-card ${cardsVisible ? `slide-up animate-delayed-${Math.min(i + 1, 5)}` : "opacity-0-initial"}`,
            "data-ocid": `education.workshop.${i + 1}`,
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl mb-3", children: workshop.icon }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-semibold text-foreground mb-2", children: workshop.title }),
    ...
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          {
            ref: headRef,
            className: `flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-16 ${headVisible ? "slide-up" : "opacity-0-initial"}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-xl", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: "bg-accent/15 text-accent-foreground border-accent/30 mb-4 px-4 py-1.5", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-4xl lg:text-5xl text-foreground mb-4 text-balance", children: [
                  ...
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Gives Back" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed", children: "Zero-waste farming means transforming every byproduct into value. From our livestock to our crop residues, each product is crafted with care and purpose." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: gridRef, className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-6", children: BYPRODUCTS.map((product, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Card,
          {
            className: `border-border shadow-card bg-card hover-lift ${gridVisible ? `slide-up animate-delayed-${Math.min(i + 1, 5)}` : "opacity-0-initial"}`,
            "data-ocid": `byproducts.product.${i + 1}`,
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl", children: product.icon }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Badge,
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-semibold text-lg text-foreground mb-2", children: product.name }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1.5", children: product.benefits.map((benefit) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: "bg-primary/10 text-primary border-primary/20 mb-4 px-4 py-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Layers, { className: "w-3.5 h-3.5 mr-1.5" }),
                "Applications"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-4xl lg:text-5xl text-foreground mb-4 text-balance", children: [
                "Where Our Products ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Come Alive" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed", children: "From backyard gardens to commercial fields, our products and expertise power healthy growing across every scale and context." })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: listRef, className: "grid md:grid-cols-2 lg:grid-cols-3 gap-6", children: USE_CASES.map((useCase, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: `group relative p-6 rounded-2xl border border-border bg-card hover:border-primary/30 hover:shadow-card transition-smooth cursor-default ${listVisible ? `slide-up animate-delayed-${Math.min(i + 1, 5)}` : "opacity-0-initial"}`,
            "data-ocid": `applications.usecase.${i + 1}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl mb-4", children: useCase.icon }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-lg text-foreground mb-2 group-hover:text-primary transition-smooth", children: useCase.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed mb-4", children: useCase.description }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-foreground/70 uppercase tracking-wider", children: "Real Examples" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1", children: useCase.examples.map((ex) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "li",
                  {
                    className: "flex items-center gap-2 text-xs text-muted-foreground",
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "w-3 h-3 text-accent shrink-0" }),
                      ex
                    ]
                  },
                  ex
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed", children: "Our commitment to sustainable farming, community education, and innovation has been recognized by leading organizations across the agricultural industry." })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: STATS.map((stat, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: `bg-card rounded-2xl p-6 text-center border border-border shadow-card ${statsVisible ? `slide-up animate-delayed-${i + 1}` : "opacity-0-initial"}`,
                "data-ocid": `achievements.stat.${i + 1}`,
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(stat.icon, { className: `w-7 h-7 ${stat.color} mx-auto mb-3` }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: ACHIEVEMENTS.map((ach, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              Card,
              {
                className: `border-border shadow-card bg-card hover-lift ${cardsVisible ? `slide-up animate-delayed-${Math.min(i + 1, 5)}` : "opacity-0-initial"}`,
                "data-ocid": `achievements.item.${i + 1}`,
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl", children: ach.icon }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-end gap-1.5", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Badge,
                        {
                          ...
                          children: TYPE_LABELS[ach.type]
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: ach.year })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-semibold text-foreground mb-2", children: ach.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: ach.description })
                ] })
              },
              ach.id
            ))
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-4xl lg:text-5xl text-foreground mb-4 text-balance", children: [
                "Voices from Our ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Community" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed", children: "From family kitchens to commercial operations, hear what our community says about their experience with Nettes Garden." })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: gridRef, className: "grid md:grid-cols-2 lg:grid-cols-3 gap-6", children: TESTIMONIALS.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: `relative p-6 rounded-2xl bg-card border border-border shadow-card hover-lift ${gridVisible ? `slide-up animate-delayed-${Math.min(i + 1, 5)}` : "opacity-0-initial"}`,
            "data-ocid": `testimonials.item.${i + 1}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Quote, { className: "w-8 h-8 text-primary/20 mb-3" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed mb-5 italic", children: t.quote }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 pt-4 border-t border-border", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium text-sm text-foreground truncate", children: t.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground truncate", children: t.role })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ml-auto flex gap-0.5 shrink-0", children: ["s1", "s2", "s3", "s4", "s5"].map((key) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Star,
                  {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: "bg-primary/10 text-primary border-primary/20 mb-4 px-4 py-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "w-3.5 h-3.5 mr-1.5" }),
                "About Us"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-4xl lg:text-5xl text-foreground mb-4 text-balance", children: [
                "Rooted in Purpose,",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Grown with Love" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed", children: "Nettes Garden is more than a business — it's a living commitment to the land, the people who work it, and the communities who depend on it." })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-2xl text-foreground mb-3", children: "Our Story" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed text-sm", children: "Founded in 2008 on 50 acres of depleted California farmland, Nettes Garden began as a bold experiment: could sustainable, regenerative farming actually outperform conventional methods? Fifteen years later, our 500+ acre operation proves every day that it can — and must." })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 gap-4", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 rounded-xl bg-primary/8 border border-primary/15", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Target, { className: "w-4 h-4 text-primary" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-foreground text-sm", children: "Mission" })
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground leading-relaxed", children: "To prove that farming can feed the world while healing the planet — one acre, one family, one season at a time." })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 rounded-xl bg-accent/10 border border-accent/20", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Eye, { className: "w-4 h-4 text-accent-foreground" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-foreground text-sm", children: "Vision" })
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground leading-relaxed", children: "A world where every community has access to nourishing, sustainably grown food, and every farmer prospers without compromise." })
                      ] })
                    ] })
                  ]
                }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: teamRef, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: `text-center mb-10 ${teamVisible ? "slide-up" : "opacity-0-initial"}`,
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-3xl text-foreground", children: "Meet the Team" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-6", children: TEAM_MEMBERS.map((member, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: `text-center p-6 rounded-2xl bg-card border border-border shadow-card hover-lift ${teamVisible ? `slide-up animate-delayed-${i + 1}` : "opacity-0-initial"}`,
              "data-ocid": `about.team.${i + 1}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-primary/10 border-2 border-primary/20 flex items-center justify-center text-3xl mx-auto mb-4", children: TEAM_AVATARS[i] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-semibold text-foreground mb-1", children: member.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-primary font-medium mb-3", children: member.role }),
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: "bg-primary/10 text-primary border-primary/20 mb-4 px-4 py-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(CircleHelp, { className: "w-3.5 h-3.5 mr-1.5" }),
                "FAQ"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-4xl lg:text-5xl text-foreground mb-4 text-balance", children: [
                "Frequently Asked ",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed", children: "Everything you need to know about Nettes Garden — from our products and certifications to visiting and workshops." })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                children: FAQS.map((faq, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  AccordionItem,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { className: "text-sm text-muted-foreground leading-relaxed pb-5", children: faq.answer })
                    ]
                  },
                  faq.id
                ))
...
function ContactSection() {
  ...
  const handleSubmit = async (e) => {
    ...
    ue.success("Message sent! We'll be in touch within 1-2 business days.");
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: "bg-primary/10 text-primary border-primary/20 mb-4 px-4 py-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "w-3.5 h-3.5 mr-1.5" }),
                "Get in Touch"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-4xl lg:text-5xl text-foreground mb-4 text-balance", children: [
                "We'd Love to ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Hear From You" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed", children: "Whether you're interested in our products, education programs, or just want to say hello — we're here and happy to help." })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-xl text-foreground mb-5", children: "Contact Information" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: "Farm Address" }),
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: "Phone" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "a",
                              {
                                href: "tel:+14155550123",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 rounded-xl bg-muted/40 border border-border", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-semibold text-foreground mb-3", children: "Farm Hours" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1.5 text-sm", children: [
                        { day: "Monday – Friday", hours: "7:00 AM – 5:00 PM" },
                        { day: "Saturday", hours: "8:00 AM – 4:00 PM" },
                        { day: "Sunday", hours: "Closed" }
                      ].map(({ day, hours }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: day }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground", children: hours })
                      ] }, day)) })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-semibold text-foreground mb-3", children: "Follow Us" }),
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 gap-5", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "contact-name", className: "text-sm font-medium", children: [
                          "Your Name ",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "contact-email", className: "text-sm font-medium", children: [
                          "Email Address ",
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive", children: "*" })
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "contact-subject", className: "text-sm font-medium", children: "Subject" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Input,
                        {
                          id: "contact-subject",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "contact-message", className: "text-sm font-medium", children: [
                        "Message ",
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive", children: "*" })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ByproductsSection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ApplicationsSection, {}),
